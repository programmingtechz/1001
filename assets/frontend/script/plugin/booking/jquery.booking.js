...
;(function($,doc,win) 
{
	...
	var booking=function(object,option)
	{
		...
		this.vehicleSelect=function(object)
		{
            ...
            object.siblings().find(".template-icon-vehicle-small-car").each(function(){
                $(this).css('background-image','url('+ $(this).attr('data-main-image')+')');
            });
			object.addClass('template-state-selected');
            object.find(".template-icon-vehicle-small-car").css('background-image','url('+object.find(".template-icon-vehicle-small-car").attr('data-hover-image')+')');				
		};
		...
		this.packageSet=function()
		{
			...
			packageList.each(function() 
			{
				...
				{
					if( $.trim(vehicleId) != $.trim(vehicleIdRelated))
                    {

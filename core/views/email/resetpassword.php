                    ...
                    <tbody>
                        <tr>
                            <td style="border-bottom:1px solid #f6f6f6;">
                                <h1 style="font-size:14px; font-family:arial; margin:0px; font-weight:bold;">Dear Sir/madam,</h1>
                        ...
                        <tr>
                            <td style="padding:10px 0 30px 0;">
                                ...
                                <center>
                                    <a href="https://dakbroincredible.com/admin/index.php/login/forgot/update" style="display: inline-block; padding: 11px 30px; margin: 20px 0px 30px; font-size: 15px; color: #fff; background: #4fc3f7; border-radius: 60px; text-decoration:none;">Reset Password</a>
                                </center>
                                <b>- Thanks (DakBro Incredible Polishing Studio Team)</b> </td>
                        </tr>
                        <tr>
                            <td style="border-top:1px solid #f6f6f6; padding-top:20px; color:#777">If the button above does not work, try copying and pasting the URL into your browser. If you continue to have problems, please feel free to contact us at info@dakbroincredible.com</td>
                        </tr>
                    </tbody>
                </table>
            </div>

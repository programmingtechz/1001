...
<style type="text/css">
body{background-image:url('http://hhcdn.s3.amazonaws.com/email/img/bg.gif');background-repeat:repeat-y no-repeat;background-position:top center;margin:0;padding:0;}
...
td, tr{padding:0;}
.cart-info td{text-align: center;}
									...
									<table width="600" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="40" align="left">
												<img src="https://s3.amazonaws.com/prod-dakbro/logo_yellow.png" style="display:block;" alt="" title="" height="32" border="0" style="max-height:32px;">
											</td>
											<td align="right" class="bold">
												<div>+9176599630<br><a href="mailto:support@dakbroincredible.com">support@dakbroincredible.com</a></div>
											</td>
							...
							<tr>
								<td align="center" colspan="3">
									...
									<table width="600" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                            <td>You account Created Successfully.</td>
                                            </tr>
...
<table width="600" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td align="left" height="100" valign="top" colspan="2">
						<div>
							DakBro
							<br>
							4B Shanthi Colony, 7th main Rd
							<br>
							NAC Jewellery adjacent street,
                            <br>
							Anna Nagar, Chennai 600040
							<br> 
							<a href="mailto:support@dakbroincredible.com" target="_blank">support@dakbroincredible.com</a>
							<br>
							<a href="http://www.dakbroincredible.com" target="_blank">http://www.dakbroincredible.com</a>
							<br>
							Contact: +919176599630
							<br>
						</div>
						<br>
					</td>
	...
	<tr><td class="copy" align="center" height="40" valign="top"><div>&copy;dakbroincredible, All rights reserved</div></td></tr>
</table>
<!-- Footer end -->
